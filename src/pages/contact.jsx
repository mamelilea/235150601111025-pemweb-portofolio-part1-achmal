...
const contact = () => {
    ...
    return (
        <div id='contact' className='w-screen lg:h-screen h-fit flex flex-col items-center lg:py-0 py-20  bg-slate-950 z-[5] sticky mb-[5rem]'>
            <div className='lg:flex lg:flex-row flex flex-col lg:justify-center items-center lg:my-20 lg:gap-10 gap-7'>
                <div className='text-white lg:w-[30rem]  rounded-2xl flex flex-col justify-center items-center'>
                    ...
                    <p data-aos="fade-left" className='lg:w-[29rem] w-[17rem] lg:text-sm text-xs text-justify text-slate-400 lg:m-5 mb-10'>I am excited about the opportunity to work with you and contribute to your projects as a front-end developer.</p>
                    {/* sosmed saya di contact */}
                    <ul className='lg:w-[29rem] flex lg:gap-5 h-10 gap-2 lg:m-5 w-[17rem]'>
                        <Tooltip title="mamelilea" placement='bottom'>
                            <a data-aos="zoom-in" href="https://github.com/mamelilea" target='_blank'><li className='relative tooltip-container w-10 h-10 bg-transparent border border-3 border-slate-50 flex justify-center items-center mail-parent hover:bg-slate-700 hover:border-slate-700 rounded-md'>
                        ...
                        <Tooltip title="Achmal" placement='bottom'>
                            <a data-aos="zoom-in" href="https://www.linkedin.com/in/achmal-pradipta-aditama-742b85285/" target='_blank'><li className='relative tooltip-container w-10 h-10 bg-transparent border border-3 border-slate-50 flex justify-center items-center mail-parent hover:bg-slate-700 hover:border-slate-700 rounded-md'>
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50">
                                    <path className='link-child' fill='#fff' d="M41,4H9C6.24,4,4,6.24,4,9v32c0,2.76,2.24,5,5,5h32c2.76,0,5-2.24,5-5V9C46,6.24,43.76,4,41,4z M17,20v19h-6V20H17z M11,14.47c0-1.4,1.2-2.47,3-2.47s2.93,1.07,3,2.47c0,1.4-1.12,2.53-3,2.53C12.2,17,11,15.87,11,14.47z M39,39h-6c0,0,0-9.26,0-10 c0-2-1-4-3.5-4.04h-0.08C27,24.96,26,27.02,26,29c0,0.91,0,10,0,10h-6V20h6v2.56c0,0,1.93-2.56,5.81-2.56 c3.97,0,7.19,2.73,7.19,8.26V39z"></path>
                                </svg>
                            </li></a>
                        </Tooltip>
                        <Tooltip title="achmalpradiptaaditama@gmail.com" placement='bottom'>
                            <a data-aos="zoom-in" href="mailto:achmalpradiptaaditama@gmail.com" target="_blank"><li className='w-10 h-10 bg-transparent border border-3 border-slate-50 flex justify-center items-center mail-parent hover:bg-slate-700 hover:border-slate-700 rounded-md'>
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50"
                                    className='mail-child'>
                                    <path fill='#fff' className='mail-child' d="M 5.5 7 C 3.019531 7 1 9.019531 1 11.5 L 1 11.925781 L 25 29 L 49 11.925781 L 49 11.5 C 49 9.019531 46.980469 7 44.5 7 Z M 6.351563 9 L 43.644531 9 L 25 22 Z M 1 14.027344 L 1 38.5 C 1 40.980469 3.019531 43 5.5 43 L 44.5 43 C 46.980469 43 49 40.980469 49 38.5 L 49 14.027344 L 43 18.296875 L 43 41 L 7 41 L 7 18.296875 Z"></path>
                                </svg>
                            </li></a>
                        </Tooltip>
                        {/* quotes */}
                ...
                <div data-aos="zoom-in-up" className="form-container lg:w-[30rem] w-80">
