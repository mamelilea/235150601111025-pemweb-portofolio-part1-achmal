...
const about = () => {
    ...
    return (
        <div id="about" className='bg-[#F5F5F5] dark:bg-slate-950 w-screen h-[80vh] py-10 z-20 relative'>
            <div className='flex flex-col justify-center items-center  w-screen h-[80%]'>
                <h1 data-aos="fade-down" className="text-[#0c0c0c] dark:text-white lg:text-4xl md:text-[3.8rem] text-2xl font-unigeo text-center m-10">About Me</h1>
                <div data-aos="fade-right" className='w-[70%]'>
                    <p className='text-center text-[#0c0c0c] dark:text-white opacity-70 font-normal lg:text-xl md:text-3xl text-base'>
