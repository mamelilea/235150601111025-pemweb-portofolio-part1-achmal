                                    ...
                                    <div className="text-center flex flex-col items-center">
                                        ...
                                        <div className="mt-10 flex items-center justify-center gap-x-6">
                                            <a
                                                ...
                                                target='_black'
                                                className="rounded-md bg-cyan-600 px-3.5 py-2.5 lg:text-sm text-xs font-semibold text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600"
                                            >
                                                MY CV
                                            </a>
                                            <a href="https://www.instagram.com/achmalp" target='_blank' className="ui-btn lg:text-base">
                                                <span>
